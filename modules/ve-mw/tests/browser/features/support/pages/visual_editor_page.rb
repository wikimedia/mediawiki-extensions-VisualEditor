...
class VisualEditorPage
  ...
  div(:disabled_save_button, css: 'div.ve-init-mw-target-toolbar .oo-ui-toolbar-actions > div.oo-ui-flaggedElement-progressive.oo-ui-widget-disabled')
...
')
  ...
  div(:save_enabled, css: 'div.ve-init-mw-target-toolbar .oo-ui-toolbar-actions > div.oo-ui-flaggedElement-progressive.oo-ui-widget-enabled')
  ...
  div(:toolbar, class: 've-init-mw-target-toolbar')
