 ...
 */
ve.ui.MWReferencesListContextItem = function VeMWReferencesListContextItem( context, model, config ) {
	// Parent constructor
	ve.ui.MWReferencesListContextItem.super.call( this, context, model, config );
