class VisualEditorPage
  ...
  a(:heading, css: "a[class='oo-ui-tool-link'][title='^2']")
  ...
  a(:page_title, css: "a[class='oo-ui-tool-link'][title='^1']")
  a(:paragraph, css: "a[class='oo-ui-tool-link'][title='^0']")
  a(:preformatted, css: "a[class='oo-ui-tool-link'][title='^7']")
