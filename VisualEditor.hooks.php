	...
	public static function onResourceLoaderTestModules(
		...
		$testModules['qunit']['ext.visualEditor.test'] = array(
			...
			'scripts' => array(
				...
				// QUnit plugin
				'lib/ve/modules/ve/tests/ve.qunit.js',
				// UnicodeJS Tests
				'lib/ve/modules/unicodejs/tests/unicodejs.test.js',
				'lib/ve/modules/unicodejs/tests/unicodejs.graphemebreak.test.js',
				'lib/ve/modules/unicodejs/tests/unicodejs.wordbreak.test.js',
				// VisualEditor Tests
				'lib/ve/modules/ve/tests/ve.test.utils.js',
				'modules/ve-mw/tests/ve.test.utils.js',
				'lib/ve/modules/ve/tests/ve.test.js',
				'lib/ve/modules/ve/tests/ve.Document.test.js',
				'lib/ve/modules/ve/tests/ve.Node.test.js',
				'lib/ve/modules/ve/tests/ve.BranchNode.test.js',
				'lib/ve/modules/ve/tests/ve.LeafNode.test.js',
				// VisualEditor DataModel Tests
				'lib/ve/modules/ve/tests/dm/ve.dm.example.js',
				'lib/ve/modules/ve/tests/dm/ve.dm.AnnotationSet.test.js',
				'lib/ve/modules/ve/tests/dm/ve.dm.NodeFactory.test.js',
				'lib/ve/modules/ve/tests/dm/ve.dm.Node.test.js',
				'lib/ve/modules/ve/tests/dm/ve.dm.Converter.test.js',
				'lib/ve/modules/ve/tests/dm/ve.dm.BranchNode.test.js',
				'lib/ve/modules/ve/tests/dm/ve.dm.LeafNode.test.js',
				'lib/ve/modules/ve/tests/dm/ve.dm.LinearData.test.js',
				'lib/ve/modules/ve/tests/dm/nodes/ve.dm.TextNode.test.js',
				'modules/ve-mw/tests/dm/nodes/ve.dm.MWTransclusionNode.test.js',
				'lib/ve/modules/ve/tests/dm/ve.dm.Document.test.js',
				'lib/ve/modules/ve/tests/dm/ve.dm.DocumentSynchronizer.test.js',
				'lib/ve/modules/ve/tests/dm/ve.dm.IndexValueStore.test.js',
				'lib/ve/modules/ve/tests/dm/ve.dm.InternalList.test.js',
				'modules/ve-mw/tests/dm/ve.dm.InternalList.test.js',
				'lib/ve/modules/ve/tests/dm/ve.dm.Transaction.test.js',
				'modules/ve-mw/tests/dm/ve.dm.Transaction.test.js',
				'lib/ve/modules/ve/tests/dm/ve.dm.TransactionProcessor.test.js',
				'lib/ve/modules/ve/tests/dm/ve.dm.Surface.test.js',
				'lib/ve/modules/ve/tests/dm/ve.dm.SurfaceFragment.test.js',
				'modules/ve-mw/tests/dm/ve.dm.SurfaceFragment.test.js',
				'lib/ve/modules/ve/tests/dm/ve.dm.ModelRegistry.test.js',
				'lib/ve/modules/ve/tests/dm/ve.dm.MetaList.test.js',
				'lib/ve/modules/ve/tests/dm/ve.dm.Model.test.js',
				'lib/ve/modules/ve/tests/dm/lineardata/ve.dm.FlatLinearData.test.js',
				'lib/ve/modules/ve/tests/dm/lineardata/ve.dm.ElementLinearData.test.js',
				'lib/ve/modules/ve/tests/dm/lineardata/ve.dm.MetaLinearData.test.js',
				...
				'lib/ve/modules/ve/tests/ce/ve.ce.test.js',
				'lib/ve/modules/ve/tests/ce/ve.ce.Document.test.js',
				'lib/ve/modules/ve/tests/ce/ve.ce.Surface.test.js',
				'modules/ve-mw/tests/ce/ve.ce.Document.test.js',
				'modules/ve-mw/tests/ce/ve.ce.Surface.test.js',
				'lib/ve/modules/ve/tests/ce/ve.ce.NodeFactory.test.js',
				'lib/ve/modules/ve/tests/ce/ve.ce.Node.test.js',
				'lib/ve/modules/ve/tests/ce/ve.ce.BranchNode.test.js',
				'lib/ve/modules/ve/tests/ce/ve.ce.ContentBranchNode.test.js',
				'modules/ve-mw/tests/ce/ve.ce.ContentBranchNode.test.js',
				'lib/ve/modules/ve/tests/ce/ve.ce.LeafNode.test.js',
				'lib/ve/modules/ve/tests/ce/nodes/ve.ce.TextNode.test.js',
				// VisualEditor Actions Tests
				'lib/ve/modules/ve/tests/ui/actions/ve.ui.AnnotationAction.test.js',
				'lib/ve/modules/ve/tests/ui/actions/ve.ui.FormatAction.test.js',
				'modules/ve-mw/tests/ui/actions/ve.ui.FormatAction.test.js',
				'lib/ve/modules/ve/tests/ui/actions/ve.ui.IndentationAction.test.js',
				'lib/ve/modules/ve/tests/ui/actions/ve.ui.ListAction.test.js',
				// VisualEditor initialization Tests
				'lib/ve/modules/ve/tests/init/ve.init.Platform.test.js',
				'modules/ve-mw/tests/init/targets/ve.init.mw.ViewPageTarget.test.js',
				// IME tests
				'lib/ve/modules/ve/tests/ce/ve.ce.TestRunner.js',
				'lib/ve/modules/ve/tests/ce/ve.ce.imetests.test.js',
				'lib/ve/modules/ve/tests/ce/imetests/backspace-chromium-ubuntu-none.js',
				'lib/ve/modules/ve/tests/ce/imetests/backspace-firefox-ubuntu-none.js',
				'lib/ve/modules/ve/tests/ce/imetests/backspace-ie-win-none.js',
				'lib/ve/modules/ve/tests/ce/imetests/input-chrome-win-chinese-traditional-handwriting.js',
				'lib/ve/modules/ve/tests/ce/imetests/input-chrome-win-greek.js',
				'lib/ve/modules/ve/tests/ce/imetests/input-chrome-win-welsh.js',
				'lib/ve/modules/ve/tests/ce/imetests/input-chromium-ubuntu-ibus-chinese-cantonese.js',
				'lib/ve/modules/ve/tests/ce/imetests/input-chromium-ubuntu-ibus-japanese-anthy-' .
					'-hiraganaonly.js',
				'lib/ve/modules/ve/tests/ce/imetests/input-chromium-ubuntu-ibus-korean-korean.js',
				'lib/ve/modules/ve/tests/ce/imetests/input-chromium-ubuntu-ibus-malayalam-swanalekha.js',
				'lib/ve/modules/ve/tests/ce/imetests/input-firefox-ubuntu-ibus-chinese-cantonese.js',
				'lib/ve/modules/ve/tests/ce/imetests/input-firefox-ubuntu-ibus-japanese-anthy--hiraganaonly.js',
				'lib/ve/modules/ve/tests/ce/imetests/input-firefox-ubuntu-ibus-korean-korean.js',
				'lib/ve/modules/ve/tests/ce/imetests/input-firefox-ubuntu-ibus-malayalam.swanalekha.js',
				'lib/ve/modules/ve/tests/ce/imetests/input-firefox-win-chinese-traditional-handwriting.js',
				'lib/ve/modules/ve/tests/ce/imetests/input-firefox-win-greek.js',
				'lib/ve/modules/ve/tests/ce/imetests/input-firefox-win-welsh.js',
				'lib/ve/modules/ve/tests/ce/imetests/input-ie-win-chinese-traditional-handwriting.js',
				'lib/ve/modules/ve/tests/ce/imetests/input-ie-win-greek.js',
				'lib/ve/modules/ve/tests/ce/imetests/input-ie-win-korean.js',
				'lib/ve/modules/ve/tests/ce/imetests/input-ie-win-welsh.js',
				'lib/ve/modules/ve/tests/ce/imetests/leftarrow-chromium-ubuntu-none.js',
				'lib/ve/modules/ve/tests/ce/imetests/leftarrow-firefox-ubuntu-none.js',
				'lib/ve/modules/ve/tests/ce/imetests/leftarrow-ie-win-none.js',
			),
			'dependencies' => array(
				'unicodejs.wordbreak',
